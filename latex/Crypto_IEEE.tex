...
\usepackage{Crypto_IEEE}                         % LaTeX 2e
...
\begin{document}
    ...
    \SubSection{Overview of Quantum Computers}
    ...
    \SubSection{Difference Between Classical Computers and Quantum Computers}
    ...
    \Section{Threats to Security Technology}
    \SubSection{Overview of Cryptography}
    ...
    \SubSection{Threats from Quantum Computing}
...
%-------------------------------------------------------------------------
    ...
    \nocite{a1,b1}
    \bibliographystyle{Crypto_IEEE.bst}
